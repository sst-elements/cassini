...
class PalaPrefetcher : public SST::MemHierarchy::CacheListener {
   public:
    ...
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(PalaPrefetcher, "cassini", "PalaPrefetcher",
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"cache_line_size",
         "Controls the cache line size of the cache the prefetcher is attached too", "64"},
        ...
        {"overrun_page_boundaries",
         "Allow prefetcher to run over page alignment boundaries, default is 0 (false)", "0"},
    ...
    SST_ELI_DOCUMENT_STATISTICS(
        ...
        {"prefetches_canceled_by_page_boundary",
         "Counts number of prefetches which spanned over page boundaries and so did not issue",
         "prefetches", 1},
        {"prefetches_canceled_by_history",
         "Counts number of prefetches which did not get issued because of prefetch history",
         "prefetches", 1},
